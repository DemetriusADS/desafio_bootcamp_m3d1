...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const transactionsList = list.data.transactions;
      const balanceList = list.data.balance;
        ...
        <TableContainer>
          <table>
            ...
            <tbody>
             ...
             <td className={transaction.type}>{transaction.type === "income" ? "" : "- "}{formatValue(Number(transaction.value))}</td>
